...
function makeTreeProcessor(nodeMapper) {  //TODO: consider making this a tree.Node method
    ...
    function inner(key, obj) {
        const root = tree$1.buildTree(obj);
...
class Circle$1 extends Shape {
    ...
    scale(factor) {
        return new Circle$1(factor * this.r);}
